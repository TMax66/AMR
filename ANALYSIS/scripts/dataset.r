...
AMR<- read_excel(here("ANALYSIS","data", "raw", "AMR2x.xlsx"))
...
AMR_com <- read_excel(here("ANALYSIS", "data", "raw", "AMR_dati completi dei comuni.xlsx"))#carica il dataset finale
...
classcom <- read_excel(here("ANALYSIS", "data", "raw",    "classcom.xlsx"))
...
pascolo <- read_excel(here("ANALYSIS", "data", "raw","pascolo.xlsx"))
