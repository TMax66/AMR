...
La resistenza dei ceppi isolati al Ceftiofur è risultata poco frequente x/su... di questi sono risultati positivi al test 49 ceppi  z.... 
Le analisi genomiche  sono state condotte su 47 isolati dal momento che due di essi sono risultati inquinati. Dalle analisi molecolari è emersa una prevalenza di E. coli dell’85,10% (40/47) e del 14,89% (7/47) per E. fergusonii. Rispetto alle analisi sui geni di resistenza, nei ceppi di E. coli è emersa una prevalenza dell’10,00% (4/40) per il gene TEM e del 2,50% (1/40) per SHV (Tabella 1). Rispetto a E. fergusonii, è stata riscontrata una prevalenza del 14,29% (1/7) per il gene SHV \ref{tab:cftres}. 
