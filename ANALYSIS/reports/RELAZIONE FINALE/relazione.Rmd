...
Sulla base di questi dati è stato progettato un studio osservazionale con l'obiettivo  di raccogliere informazioni sulla presenza e diffusione dell'antibiotico-resistenza in ceppi batterici della famiglia delle Enterobacteriacee isolati da feci di un ampio spettro di specie di fauna selvatica, presente in varie province della Lombardia con differenti gradi di urbanizzazione;  la loro caratterizzazione fenotipica  di resistenza e quella genotipica utilizzando metodiche di analisi metagenomica su  pools di ceppi batterici di Escherichia coli. (@ahmed_prevalence_2016)
...
In questo studio i profili di biodiversità suggeriscono la presenza di tre gruppi differenti: fa gruppo a se 

.. bassa prevalenza di ceppi multi-resistenti >>>>> no espansione clonale  ma più probabile la  contaminazione ambientale... diversità dei fenotipi per gruppi-specie riflette la frequentazione di ambienti simili in quanto a contaminazione con resistomi....
