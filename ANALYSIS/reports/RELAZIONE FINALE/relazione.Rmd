...
L'U.O. 1  ha svolto regolarmente le attività  per quel che riguarda la parte analitica, relativamente alla disponibilità dei campioni di feci inviati dalle U. O. 5 e 6. A Febbraio del 2019 a conclusione della parte analitica di isolamento,  identificazione,  test di suscettibilità dei ceppi e loro archiviazione si è proceduto all'invio dei pool di ceppi di Escherichia coli all'U.O.2 per le attività di analisi metagenomica. L'attività di analisi dei dati fenotipici si è conclusa a Maggio del 2020, mentre l'editing della relazione finale è iniziata a Giugno 2020 e si è conclusa a Novembre 2020, con l'invio della relazione finale in data  . Il 

L'U.O. 2 ha ricevuto i campioni per le analisi metagenomiche a Febbraio 2019 e ha concluso le attività il 2/11/2020 con l'invio all'U.O. 1 di una relazione delle attvità svolte.  A causa della scadenza prossima dell'invio della relazione finale alla Direzione Generale dell'IZLSER prevista per il 7/11/2020, non essendo stato possibile  procedere a una  valutazione, discussione ed eventuali integrazione dei risultati e considerazioni relative alle analisi metagenomiche il responsabile scientifico ha ritenuto opportuno inserire il contributo della U.O. come allegato alla relazione finale del progetto di ricerca.
...
### Territorio
L'attività di campionamento si è svolta tra Settembre 2017 e Dicembre 2018  in sette province della Lombardia : Bergamo, Pavia, Varese,Como, Lecco e Brescia da un totale di 223 comuni (Fig\ref{fig:fig1}). 
...
I risultati ottenuti sono coerenti con gli altri studi pubblicati, e sebbene il confronto non sempre è possibile per differenti modalità di campionamento, specie campionate, antibiotici testati, si può osservare che gli antibiotici  verso cui i ceppi di enterobacteriacee isolati mostrano maggiore resistenza sono principalmente quelli del gruppo delle $\beta$-lattamasi (Ampicillina, Amoxicillina, Amoxicillina-Ac.Clavulanico), Tetracicline e aminoglicosidi [@foti_study_2018]. I risultati emersi dalla caratterizzazione genomica dei ceppi resistenti a Ceftiofir, con l'individuazione a bassa prevaelnza dei soli geni TEM e SHV dimostra la presenza di ceppi ESBL nel comparto selvatico limitatamente al gruppo specie CERVIDI da campioni di feci prelevati da animali provenienti dai territori della provincia di Sondrio. 
