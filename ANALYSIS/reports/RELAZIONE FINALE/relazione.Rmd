...
Anche all’interno dei pool prelevati nelle singole province di Bergamo e Sondrio sembrano emergere pattern differenti di AMR in funzione dell’altitudine di prelievo. In particolare, i pool prelevati da animali che vivono ad altitudini maggiori mostrano generalmente una maggiore presenza di geni AMR in tutte le classi fenotipiche (Figura 5 per Bergamo e Figura 6 per Sondrio).
