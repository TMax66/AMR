...
### Territorio
L'attività di campionamento si è svolta tra Settembre 2017 e Dicembre 2019  in sette province della Lombardia : Bergamo, Pavia, Varese,Como, Lecco e Brescia da un totale di 223 comuni (Fig\ref{fig:fig-1}). 
...
I campioni dei Corvidi come indicato prima provengono infatti da aree ad alta urbanizzazione dove,  come già indicato in letteratura (cit....) la frequentazione delle discariche per procurasi il cibo rappresenta il principale meccanismo espositivo che determina la cross-contaminazione ambiente-animale in grado di favorire il mantenimento e diffusione di ceppi e materiale genetico di resistenza. I campioni dei Cervidi e Suidi provengono da territori montani ma con un grado di urbanizzazione medio-bassa  e quindi meno antropomorfizzati (collinare/premontano) rispetto ai corvidi e quindi con minori occasioni di contaminazione con materiale di provenienza umana o da animali domestici. Infine i campioni dei BOVIDI provengono da ambienti totalmente montani con ridotta urbanizzazione. Lo stesso trend si osserva anche per i casi "multi-resistenti" ma con entità di prevalenza decisamente più ridotti. 
