...
```{r echo=FALSE, rabplot, fig.align = "center",out.width = '90%', fig.cap="Distribuzione a posteriori delle stime di prevalenza di ceppi resistenti al panel di antibiotici nei differenti gruppi-specie"}
...
\begin{table}
\caption{\label{tab:}Profilo di antibiotico-resistenza tra i  diversi generi dei ceppi isolati}
\centering
