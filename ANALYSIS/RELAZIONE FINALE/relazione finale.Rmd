...
```{r echo=FALSE, stimefe, fig.align = "center",out.width = '90%', fig.cap="Distribuzione a posteriori delle stime dei coefficenti di regressione del modello 2"}

knitr::include_graphics("figure/stimefe.png")
```

```{r echo=FALSE, condplot, fig.align = "left",out.width = '110%', fig.cap="Stima dell'effetto 'Superficie adibita al pascolo' sulla probabilità di un animale di essere carrier di ceppi antibiotico-resistenti, condizionalmente al gruppo-specie di appartenenza"}

knitr::include_graphics("figure/condplot.png")
```


```{r echo=FALSE, rabplot, fig.align = "center",out.width = '110%', fig.cap="Distribuzione a posteriori delle stime di prevalenza di ceppi resistenti al panel di antibiotici nei differenti gruppi-specie"}

knitr::include_graphics("figure/rabgraf.png")
```


```{r echo=FALSE, pcores, fig.align = "center",out.width = '100%', fig.cap="Distribuzione della frequenza dei differenti profili fenotipici di resistenza"}

knitr::include_graphics("figure/cores.png")
```


```{r echo=FALSE, heatmap, fig.align = "center", out.width = '100%', fig.cap="Distribuzione della frequenza dei differenti profili fenotipici di resistenza nei differenti gruppi-specie di provenienza dei campioni"}
