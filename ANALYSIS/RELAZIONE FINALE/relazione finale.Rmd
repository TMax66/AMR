...
\begin{table}[h]
\centering
\caption{Distribuzione del numero e percentuale \% del differenti specie di fauna selvatica di origine dei campioni di feci}
