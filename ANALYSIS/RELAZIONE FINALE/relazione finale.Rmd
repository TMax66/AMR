...
## PREVALENZA ANIMALI PORTATORI DI CEPPI RESISTENTI
...
```{r echo=FALSE, condplot, fig.align = "center",out.width = '90%', fig.cap="Stima dell'effetto Superficie adibita al pascolo sulla probabilità di un animale di essere carrier di ceppi antibiotico-resistenti, condizionalmente al gruppo-specie di appartenenza"}
