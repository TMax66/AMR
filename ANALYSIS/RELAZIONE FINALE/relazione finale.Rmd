...
$$R_i \sim \text Binomial(1,p)$$
$$\text logit(p) = \alpha + \beta*Specie $$ $$\alpha \sim Normal (0, 1)$$ $$\beta \sim Normal (0,1)$$ 
utilizzando la funzione stan_glm() del pacchetto rstanarm, da cui sono state estratte gli effetti marginali ottenendo le distribuzioni a posteriore del logit della prevalenza trasformato in probabilità mediante la funzione: 
